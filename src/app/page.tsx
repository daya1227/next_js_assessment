  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      ...
      <div className="flex flex-1 relative">
        {/* Left Navigation */}
        {showLeftNav && (
          <div className="fixed inset-0 bg-black opacity-30 md:hidden"></div>
        )}
        ...
        {/* Right Info Panel - Initially Hidden on Big Screens */}
        <aside
          ...
          ${
            showRightInfo ? "translate-x-0" : "translate-x-full"
